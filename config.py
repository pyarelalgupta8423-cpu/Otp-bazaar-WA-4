...
# UPI IDs
# Manual = screenshot + admin approve | Automatic = API verify
UPI_MID = os.getenv("UPI_MID", "")
UPI_ID = os.getenv("UPI_ID", "")  # legacy fallback
UPI_ID_MANUAL = os.getenv("UPI_ID_MANUAL", "") or os.getenv("UPI_ID", "")
UPI_ID_AUTO = os.getenv("UPI_ID_AUTO", "") or os.getenv("UPI_ID", "")

# FamPay / Auto UPI Verification API
FAMPAY_QR_URL = os.getenv("FAMPAY_QR_URL", "")
FAMPAY_VERIFY_URL = os.getenv("FAMPAY_VERIFY_URL", "")
FAMPAY_API_KEY = os.getenv("FAMPAY_API_KEY", "")

OTP_REGEX = r"\b\d{4,8}\b"
AUTO_CANCEL_SECONDS = 600
WA_NUMBER_TIMEOUT_SECONDS = 1200  # 20 min for admin to provide WhatsApp number
