...
def get_persistent_menu(uid):
    ...
    from telethon import Button
    buttons = [
        [Button.text("🛒 𝐁ᴜʏ 𝐀ᴄᴄᴏᴜɴᴛ", style="success", icon=5440627033111557670), Button.text("📁 𝐁ᴜʏ 𝐒ᴇssɪᴏɴs", style="primary", icon=5355292788923593967)],
        [Button.text("📱 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩", style="success", icon=5408995930416362034), Button.text("💳 𝐃ᴇᴘᴏsɪᴛ", style="primary", icon=5409271925014801629)],
        [Button.text("📦 𝐌ʏ 𝐎ʀᴅᴇʀs", style="primary", icon=5409098988156629257), Button.text("👤 𝐏ʀᴏғɪʟᴇ", style="primary", icon=6203982793379154737)],
